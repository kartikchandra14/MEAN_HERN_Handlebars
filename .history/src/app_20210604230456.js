...
app.post("/login", async(req,res) => {
    try{
        ...
        if(req.body.email && req.body.password){
            ...
            const isEmailExist = await StudentModel.find({email: emailPassed});
            ...
            if(isEmailExist){
                ...
                const tokenGeneratd = await StudentModel.generateAuthToken();// after password match generation of token 
